import {
  ...
  function Grammar() {
    ...
    const handlePress = (videoId) => {
      ...
      const FetchGrammarItems = async (videoId) => {
        try {
          ...
          if (data.success) {
            ...
            const items = Object.values(data.data).filter(item => item.topic === "Grammar");
        ...
        <SafeAreaView style={styles.lAContainer}>
            ...
            <ScrollView style={styles.lAScrollViewContent}>
                ...
                <TouchableOpacity onPress={() => navigation.goBack()}>
                    ...
                    {!showSearchBar && (
                        <Text style={styles.lAHeaderText}>{`Grammar`}</Text>
                    )}
