import {
  ...
  function PhrasesClausesandSentences() {
    ...
    const handlePress = (videoId) => {
      ...
      const FetchPCSItems = async (videoId) => {
        try {
          ...
          if (data.success) {
            ...
            const items = Object.values(data.data).filter(item => item.topic === "Phrases, clauses and sentences");
            setPCSItems(items);
        ...
        <SafeAreaView style={styles.lAContainer}>
            ...
            <ScrollView style={styles.lAScrollViewContent}>
                ...
                <TouchableOpacity onPress={() => navigation.goBack()}>
                    ...
                    {!showSearchBar && (
                        <Text style={styles.lAHeaderText}> {`Phrases, clauses\nand sentences`}</Text>
                    )}
  ...
  export default PhrasesClausesandSentences;