import {
  ...
  function ReadingandWriting() {
    ...
    const handlePress = (videoId) => {
      ...
      const ReadingandWritingItems = async (videoId) => {
        try {
          ...
          if (data.success) {
            ...
            const items = Object.values(data.data).filter(item => item.topic === "Reading and writing");
            setReadingandWritingItems(items);
        ...
        <SafeAreaView style={styles.lAContainer}>
            ...
            <ScrollView style={styles.lAScrollViewContent}>
                ...
                <TouchableOpacity onPress={() => navigation.goBack()}>
                    ...
                    {!showSearchBar && (
                        <Text style={styles.lAHeaderText}>{`Reading and\nWriting`}</Text>
                    )}
                ...
                {readingandWritingItems.map((card, index) => (
