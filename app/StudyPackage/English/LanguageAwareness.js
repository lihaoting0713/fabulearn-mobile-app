import {
  ...
  function LanguageAwareness() {
    ...
    const [languageAwarenessItems, setLanguageAwarenessItems] = useState([]);
    ...
    const handlePress = (videoId) => {
      ...
      const LanguageAwarenessItems = async (videoId) => {
        try {
          ...
          if (data.success) {
            ...
            const items = Object.values(data.data).filter(item => item.topic === "Language awareness");
            setLanguageAwarenessItems(items);
        ...
        <SafeAreaView style={styles.lAContainer}>
            ...
            <ScrollView style={styles.lAScrollViewContent}>
                ...
                <TouchableOpacity onPress={() => navigation.goBack()}>
                    ...
                    {!showSearchBar && (
                        <Text style={styles.lAHeaderText}>{`Language\nAwareness`}</Text>
                    )}
                ...
                {languageAwarenessItems.map((card, index) => (
