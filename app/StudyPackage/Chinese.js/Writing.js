import {
  ...
  function Writing() {
    ...
    const handlePress = (videoId) => {
      ...
      const WritingItems = async (videoId) => {
        try {
          ...
          if (data.success) {
            ...
            const items = Object.values(data.data).filter(item => item.topic === "寫作");
        ...
        <SafeAreaView style={styles.lAContainer}>
            ...
            <ScrollView style={styles.lAScrollViewContent}>
                ...
                <TouchableOpacity onPress={() => navigation.goBack()}>
                    ...
                    {!showSearchBar && (
                        <Text style={styles.lAHeaderText}>{`寫作`}</Text>
                    )}
